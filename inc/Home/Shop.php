    ...
    <div class="grid">
      <div class="left">
        <div class="contact">
          ...
          <a href="tel:21969062770" target="_blank">
          ...
          <a href="mailto:itaipu@dapenhasalgaderia.com" target="_blank">
            ...
            itaipu@dapenhasalgaderia.com
          </a>

          <a href="https://goo.gl/maps/YR8EyAmPCn36YT4w6" target="_blank">
            ...
            Av. Ewerton Xavier, 1800 - loja 4<br /> Itaipu, Niterói - RJ
          </a>
      ...
      <div class="right">
        ...
        <div class="schedules">
          ...
          <div>
            <h4>Horários</h4>
            <ul>
              <li>Segunda: 09h às 18h</li>
              <li>Terça: 09h às 18h</li>
              <li>Quarta: 09h às 19h</li>
              <li>Quinta: 09h às 19h</li>
              <li>Sexta: 09h às 19h</li>
          ...
          <div>
            <h4>Delivery</h4>
            <ul>
              <li>Segunda: 13h às 18h</li>
              <li>Terça: 13h às 18h</li>
              <li>Quarta: 14h às 19h</li>
              <li>Quinta: 14h às 19h</li>
              <li>Sexta: 14h às 19h</li>
              <li>Sábado: 09h às 14h</li>
              <li>Domingo: Fechado</li>
            </ul>
          </div>
